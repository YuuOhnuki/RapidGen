      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="flex-1 flex flex-col p-4 lg:p-8">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-left">編集前</h3>
                <ImageCard imageUrl={imageUrl} changed={false}/>
                </div>

              {/* After Image */}
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-left">編集後</h3>
          ...
          <div className="flex justify-center gap-4 mt-6 pb-4">
            <Button onClick={handleExecute} size="lg" className="w-full max-w-md py-6">
              変更を保存して実行
            </Button>
          </div>
        </div>
        ...
        <ControlPanel isPanelOpen={isPanelOpen} handleReset={handleReset} />
      </div>
    </div>
  )
}
